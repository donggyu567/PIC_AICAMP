...
/** Serializes only the masked contract. raw_text can never enter this payload. */
class MaskedTranscriptJsonSerializer {
    fun serialize(transcript: MaskedTranscript): String = buildString {
        append("{\n")
        append("  \"schema_version\": ")
        appendJsonString(transcript.schemaVersion)
        append(",\n")
